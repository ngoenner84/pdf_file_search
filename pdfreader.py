...
def main():
    output, fieldnames, filenames = pdf_search()
    pdf_results_write(output, fieldnames, filenames)
...
def pdf_search():
    ...
    return output, fieldnames, filenames


def pdf_results_write(output, fieldnames, filenames):
